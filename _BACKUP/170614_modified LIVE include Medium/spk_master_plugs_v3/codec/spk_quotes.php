...
function ur_quote_func() {
    ...
    return '<span id="quote_content">
                '.$posts2[0]->post_content.'
                <br /><br />
                By: '.get_the_terms( $posts2[0]->id, 'quoter' )[0]->name.'
            </span>
            <input type="hidden" value="'.$pid.'" id="ur_quote_pid" />';
...
function ur_quote_enqueue_our_scripts() {
    ...
    wp_enqueue_script( 'ur_quote_js', plugin_dir_url( __FILE__ ).'../js/spk_asset_quotes.js', NULL, NULL, true );
}
