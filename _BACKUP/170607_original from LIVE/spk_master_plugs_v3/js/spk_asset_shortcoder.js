var FileLoc = location.protocol + "//" + location.host + "/wp-content/plugins/spk_master_plugs_v3/ajax/",
    FadeSpeed = 'fast',
    MaxAtts = 20;
...
function ListCustomFields( pid ) {
    jQuery.ajax({
        type: "POST",
        url: FileLoc + "spk_sc_custom_fields.php",
        data: 'pid='+pid,
        datatype: "html",
...
function ListTaxonomies( pid ) {
    jQuery.ajax({
        type: "POST",
        url: FileLoc + "spk_sc_taxonomies.php",
        data: 'pid='+pid,
        datatype: "html",
        success: function(result){
