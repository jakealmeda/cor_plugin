...
function spk_sc_enqueue_scripts() {
    ...
    if( 'spk_shortcoders' == get_current_screen()->post_type ) {
        ...
        wp_enqueue_script( 'spk_shortcoder_js', plugins_url( '../js/spk_asset_shortcoder_min.js', __FILE__ ), NULL, NULL, true );

        // enqueue styles
        wp_enqueue_style( 'spk_shortcoder_css', plugin_dir_url( __FILE__ ).'../css/style.css' );
    }
